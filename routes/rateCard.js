...
router.post("/create", auth, upload.single("image"), async (req, res) => {
  try {
    ...
    console.log("Creating RateCard:", newCard);
...
router.post("/:objectId/rate", auth, async (req, res) => {
  try {
...
// PUT /api/ratecards/:id/edit-rating
router.put("/:id/edit-rating", auth, async (req, res) => {
  const { rating, comment } = req.body;
  const { id } = req.params;
...
// DELETE /api/ratecards/:id/delete-rating
router.delete("/:id/delete-rating", auth, async (req, res) => {
  const { id } = req.params;
